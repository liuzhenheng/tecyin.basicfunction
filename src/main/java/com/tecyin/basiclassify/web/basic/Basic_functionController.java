...
import com.tecyin.basiclassify.repository.dao.function.Basic_functionRepository;
import com.tecyin.basiclassify.repository.dao.function.Basic_function_class2Repository;
import com.tecyin.basiclassify.repository.dao.function.Basic_function_class3Repository;
...
//          22 根据编码和名称查询Basic_function 表级下所有的用户
    ...
    public Result findOneBasicFunc(@RequestParam("basic_function_id") int id) {
        Basic_function byId = null;
        try {
            byId = basic_functionRepository.findById(id).get();
            //判断获取的数据是否为空
    ...
    public Result findPage(@RequestParam(value = "page", defaultValue = "1") int page,
        ...
        Page<Basic_function> all = basic_functionRepository.findAll(pageable);
    ...
    public Result findBasicFuncDataId(@RequestParam("findBasicFuncDataId") int findBasicFuncDataId) {
        List<Basic_function> funcDataId = basic_functionRepository.findByDataid(findBasicFuncDataId);
        //判断获取的数据是否为空
    ...
    public Result findOneBasicFuncCla2(@RequestParam("basic_function_class2_id") int basic_function_class2_id) {
        Basic_function_class2 byId = null;
        try {
            byId = basic_function_class2Repository.findById(basic_function_class2_id).get();
            //判断获取的数据是否为空
            if (byId.equals("") && byId == null) {
                return new Result(ResultCode.FAIL);
            } else {
    ...
    public Result findBasicFuncCla2FuncId(
            @RequestParam(value = "basic_function_class2_func_id", defaultValue = "1") int basic_function_class2_func_id) {
        List<Basic_function_class2> funcClass2FuncId = basic_function_class2Repository.findFuncClass2FuncId(basic_function_class2_func_id);
        //判断获取的数据是否为空
    ...
    public Result findOneBasicFuncCla3(@RequestParam(value = "basic_function_class3_id", defaultValue = "1") int basic_function_class3_id) {
        Basic_function_class3 byId = basic_function_class3Repository.findById(basic_function_class3_id).get();
        //判断获取的数据是否为空
    ...
    public Result findBasicFuncCla3FuncId(
            @RequestParam(value = "basic_function_class3_func2_id", defaultValue = "1") int basic_function_class3_func2_id) {
        List<Basic_function_class3> funcClass3FuncId =
                basic_function_class3Repository.findFuncClass3FuncId(basic_function_class3_func2_id);
        //判断获取的数据是否为空
    ...
    public Result updateBasicFunc(
            ...
            @RequestParam(value = "basic_function_data_id", defaultValue = "0") int basic_function_data_id) {
        Result result = null;
        Basic_function bu = null;
        try {
            bu = basic_functionRepository.findById(basic_function_id).get();
            ...
            basic_functionRepository.save(bu);
    ...
    public Result updateBasicFunClass2(
            ...
            @RequestParam(value = "basic_function_class2_func_id", defaultValue = "0") int basic_function_class2_func_id) {
        Result result = null;
        Basic_function_class2 bu = null;
        try {
            bu = basic_function_class2Repository.findById(basic_function_class2_id).get();
            ...
            bu = basic_function_class2Repository.save(bu);
            result = new Result(ResultCode.SUCCESS, bu);
        } catch (Exception e) {
            result = new Result(ResultCode.FAIL);
        }
    ...
    public Result updateBasicFunClass3(
            ...
            @RequestParam(value = "basic_function_class3_func2_id", defaultValue = "0") int basic_function_class3_func2_id) {
        Result result = null;
        Basic_function_class3 bu = null;
        try {
            bu = basic_function_class3Repository.findById(basic_function_class3_id).get();
            ...
            basic_function_class3Repository.save(bu);
            result = new Result(ResultCode.SUCCESS, bu);
        } catch (Exception e) {
            result = new Result(ResultCode.FAIL);
        }
    ...
    public Result deleteBasicFunClass3(@RequestParam(value = "basic_function_class3_id", defaultValue = "1") int basic_function_class3_id) {
        Result result = null;
        List<Basic_function_class3> all = null;
        // 1，删除之后，查询所有的数据，再得到所有的主键，如果有主键等于ID，就删除失败，如果没有主键等于ID就上次成功，
        try {
            basic_function_class3Repository.deleteById(basic_function_class3_id);
            all = basic_function_class3Repository.findAll();
            if (all.size() != 0) {
                //判断获取的数据是否为空
