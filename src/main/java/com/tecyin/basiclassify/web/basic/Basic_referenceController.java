...
import com.tecyin.basiclassify.repository.dao.reference.Basic_referenceRepository;
import com.tecyin.basiclassify.repository.dao.reference.Basic_reference_class2Repository;
import com.tecyin.basiclassify.repository.dao.reference.Basic_reference_class3Repository;
...
public class Basic_referenceController {
    @Autowired
    private Basic_referenceRepository br1;
    @Autowired
    private Basic_reference_class2Repository br2;
    @Autowired
    private Basic_reference_class3Repository br3;
...
//            22 根据编码和名称查询basic_function表以及级下所有的对象
        ...
        if (type == 1) {
//            1 根据id查询Basic_function表
            m = new ModelAndView("forward:/reference/findOneBasicFunc");
            m.addObject("basic_function_id", basic_function_id);
        } else if (type == 2) {
//            2 分页查询Basic_function表
            m = new ModelAndView("forward:/reference/findPage");
            m.addObject("page", page);
            m.addObject("limit", limit);
        } else if (type == 3) {
//            3 根据外键查询Basic_function 表
            m = new ModelAndView("forward:/reference/findBasicFuncDataId");
            m.addObject("findBasicFuncDataId", findBasicFuncDataId);
        } else if (type == 4) {
//            4 查询Basic_function 表的所有
            m = new ModelAndView("forward:/reference/findBasicFunctionAll");
        } else if (type == 5) {
//            5 根据ID查询Basic_function_class2 表
            m = new ModelAndView("forward:/reference/findOneBasicFuncCla2");
            m.addObject("basic_function_class2_id", basic_function_class2_id);
        } else if (type == 6) {
//            6 根据外键查询Basic_function_class2 表外键
            m = new ModelAndView("forward:/reference/findBasicFuncCla2FuncId");
...
//            7 查询Basic_function_class2表的所有 findBasicFuncClass2All
            m = new ModelAndView("forward:/reference/findBasicFuncClass2All");

        } else if (type == 8) {
//            8 根据ID查询Basic_function_class3 表
            m = new ModelAndView("forward:/reference/findOneBasicFuncCla3");
            m.addObject("basic_function_class3_id", basic_function_class3_id);
        } else if (type == 9) {
//            9 根据外键查询Basic_function_class3 表
            m = new ModelAndView("forward:/reference/findBasicFuncCla3FuncId");
            m.addObject("basic_function_class3_func2_id", basic_function_class3_func2_id);
        } else if (type == 10) {
//            10 查询Basic_function_class3表的所有
            m = new ModelAndView("forward:/reference/findBasicFuncClass3All");
        } else if (type == 11) {
//            11 增加Basic_function表的对象
            m = new ModelAndView("forward:/reference/addBasicFunc");
...
//            12 增加basic_function_class2表的对象
            m = new ModelAndView("forward:/reference/addBasicFuncCla2");
...
//            13 增加basic_function_class3表的对象
            m = new ModelAndView("forward:/reference/addBasicFuncCla3");
...
//            14 修改Basic_function表的数据
            m = new ModelAndView("forward:/reference/updateBasicFunc");
            m.addObject("basic_function_id", basic_function_id);
            m.addObject("basic_function_code", basic_function_code);
            m.addObject("basic_function_name", basic_function_name);
            m.addObject("basic_function_data_id", basic_function_data_id);
...
//            15 修改basic_function_class2表的数据
            m = new ModelAndView("forward:/reference/updateBasicFunClass2");
            m.addObject("basic_function_class2_id", basic_function_class2_id);
            m.addObject("basic_function_class2_code", basic_function_class2_code);
            m.addObject("basic_function_class2_name", basic_function_class2_name);
            m.addObject("basic_function_class2_func_id", basic_function_class2_func_id);
...
//          16 修改basic_function_class3表的数据
            m = new ModelAndView("forward:/reference/updateBasicFunClass3");
            m.addObject("basic_function_class3_id", basic_function_class3_id);
            m.addObject("basic_function_class3_code", basic_function_class3_code);
            m.addObject("basic_function_class3_name", basic_function_class3_name);
            m.addObject("basic_function_class3_func2_id", basic_function_class3_func2_id);
...
//          17 第一次请求查看 Basic_function 表下级有没有数据，没有就删除
            m = new ModelAndView("forward:/reference/deleteFunSure");
            m.addObject("basic_function_id", basic_function_id);
        } else if (type == 18) {
//          18 删除 basic_function 表级下所有的数据
            m = new ModelAndView("forward:/reference/deleteBasicFunc");
            m.addObject("basic_function_id", basic_function_id);
        } else if (type == 19) {
//          19 第一次请求查看basic_function_class2 表下级有没有数据，没有就删除
            m = new ModelAndView("forward:/reference/deleteBasicFunClass2");
            m.addObject("basic_function_class2_id", basic_function_class2_id);
        } else if (type == 20) {
//          20 确定删除Basic_function_class2下所有的数据
            m = new ModelAndView("forward:/reference/delete2Sure");
            m.addObject("basic_function_class2_id", basic_function_class2_id);
        } else if (type == 21) {
//          21 根据id删除basic_function_class3表的数据
            m = new ModelAndView("forward:/reference/deleteBasicFunClass3");
            m.addObject("basic_function_class3_id", basic_function_class3_id);
        } else if (type == 22) {
//          22 根据编码和名称查询Basic_function 表级下所有的用户
            m = new ModelAndView("forward:/reference/findFuncCodeName");
    ...
    public Result findPage(@RequestParam(value = "page", defaultValue = "1") int page,
        ...
        Page<Basic_reference> all = br1.findAll(pageable);
    ...
    public Result findBasicFuncDataId(@RequestParam("findBasicFuncDataId") int findBasicFuncDataId) {
        List<Basic_reference> funcDataId = br1.findByDataid(findBasicFuncDataId);
        //判断获取的数据是否为空
    ...
    public Result findBasicFunctionAll() {
        List<Basic_reference> all = br1.findAll();
        //判断获取的数据是否为空
        if (all.size() != 0) {
            return new Result(ResultCode.SUCCESS, all);
        } else {
    ...
    public Result findOneBasicFuncCla2(@RequestParam("basic_function_class2_id") int basic_function_class2_id) {
        Basic_reference_class2 byId = null;
        try {
    ...
    public Result findBasicFuncCla2FuncId(
            @RequestParam(value = "basic_function_class2_func_id", defaultValue = "1") int basic_function_class2_func_id) {
        List<Basic_reference_class2> funcClass2FuncId = br2.findFuncClass2FuncId(basic_function_class2_func_id);
        //判断获取的数据是否为空
    ...
    public Result findBasicFuncClass2All() {
        List<Basic_reference_class2> all = br2.findAll();
        //判断获取的数据是否为空
        if (all.size() != 0) {
            return new Result(ResultCode.SUCCESS, all);
        } else {
    ...
    public Result findOneBasicFuncCla3(@RequestParam(value = "basic_function_class3_id", defaultValue = "1") int basic_function_class3_id) {
        Basic_reference_class3 byId = br3.findById(basic_function_class3_id).get();
        //判断获取的数据是否为空
    ...
    public Result findBasicFuncCla3FuncId(
            @RequestParam(value = "basic_function_class3_func2_id", defaultValue = "1") int basic_function_class3_func2_id) {
        List<Basic_reference_class3> funcClass3FuncId =
    ...
    public Result findBasicFuncClass3All() {
        List<Basic_reference_class3> all = br3.findAll();
        //判断获取的数据是否为空
        if (all.size() != 0) {
            return new Result(ResultCode.SUCCESS, all);
        } else {
    ...
    public Result addBasicFunc(
        ...
        Basic_reference b = new Basic_reference();
        ...
        Basic_reference saveResult = br1.save(b);
        //判断获取的数据是否为空
    ...
    public Result addBasicFuncCla2(
        ...
        Basic_reference_class2 bc = new Basic_reference_class2();
        ...
        Basic_reference_class2 saveResult = br2.save(bc);
        //判断获取的数据是否为空
        if (saveResult.equals("") && saveResult == null) {
            return new Result(ResultCode.FAIL);
        } else {
    ...
    public Result addBasicFuncCla3(
        ...
        Basic_reference_class3 bc3 = new Basic_reference_class3();
        ...
        Basic_reference_class3 saveResult = br3.save(bc3);
        //判断获取的数据是否为空
        if (saveResult.equals("") && saveResult == null) {
            return new Result(ResultCode.FAIL);
        } else {
    ...
    public Result updateBasicFunClass2(
            ...
            @RequestParam(value = "basic_function_class2_func_id", defaultValue = "0") int basic_function_class2_func_id) {
        Result result = null;
        Basic_reference_class2 bu = null;
        try {
    ...
    public Result updateBasicFunClass3(
            ...
            @RequestParam(value = "basic_function_class3_func2_id", defaultValue = "0") int basic_function_class3_func2_id) {
        Result result = null;
        Basic_reference_class3 bu = null;
        try {
    ...
    public Result deleteFunSure(@RequestParam(value = "basic_function_id", defaultValue = "1") int id) {
        ...
        List<Basic_reference_class2> class2FuncId = br2.findFuncClass2FuncId(id);
    ...
    public Result deleteBasicFunc(@RequestParam(value = "basic_function_id", defaultValue = "1") int id) {
        ...
        if (class2FuncId.size() != 0) {
            //遍历数组得到每组2级的数据
            for (Basic_reference_class2 b : class2FuncId) {
                // 拿到二级的数据，再拿到二级的ID，
                int class2_id = b.getBasic_function_class2_id();
                // 根据2级的ID去查找3级的外键集合
                List<Basic_reference_class3> class3FuncId = br3.findFuncClass3FuncId(class2_id);
                // 去删除三级的数据
                if (class3FuncId.size() != 0) {
                    for (Basic_reference_class3 b3 : class3FuncId) {
                        br3.delete(b3);
                    }
                }
                //根据2级的ID删除
    ...
    public Result deleteBasicFunClass2(
        ...
        Result result = null;
        //传过来的ID，查询下一级是否有数据,此时是根据外键查询
        List<Basic_reference_class3> class3FuncId = br3.findFuncClass3FuncId(id);
        if (class3FuncId.size() != 0) {
            //如果有数据，就返回确定删除吗
            result = new Result(ResultCode.MAKESURE);
        } else {
    ...
    public Result delete2Sure(
        ...
        if (class3FuncId.size() != 0) {
            //遍历数组得到每组2级的数据
            for (Basic_reference_class3 b : class3FuncId) {
                // 拿到3 级的数据，再删除3 级的数据
                br3.delete(b);
            }
        }
    ...
    public Result deleteBasicFunClass3(@RequestParam(value = "basic_function_class3_id", defaultValue = "1") int basic_function_class3_id) {
        Result result = null;
        List<Basic_reference_class3> all = null;
        ...
        try {
            ...
            if (all.size() != 0) {
                //判断获取的数据是否为空
                for (Basic_reference_class3 b : all) {
    ...
    public Result findFuncCodeName(
        ...
        List<Basic_reference> codeAndName = br1.findCodeAndName(code, name);
        if (codeAndName.size() != 0) {
            map.put("codeAndName", codeAndName);
            map.put("basic_lv", "1");
            result = new Result(ResultCode.SUCCESS, map);
        } else {
            List<Basic_reference_class2> class2CodeAndName = br2.findClass2CodeAndName(code, name);
            if (class2CodeAndName.size() != 0) {
                map.put("class2CodeAndName", class2CodeAndName);
                map.put("basic_lv", "2");
                result = new Result(ResultCode.SUCCESS, map);
            } else {
                List<Basic_reference_class3> class3CodeAndName = br3.findClass3CodeAndName(code, name);
